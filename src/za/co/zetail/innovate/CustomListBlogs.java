...
public class CustomListBlogs extends ArrayAdapter<String> {
	...
	private final ArrayList<String> blog_pic;
	private final ArrayList<String> user_pic;
	private final ArrayList<String> updated;
	
	public CustomListBlogs(Activity context, ArrayList<String> nid2, ArrayList<String> title2, ArrayList<String> description2
			, ArrayList<String> username2, ArrayList<String> blog_pic2, ArrayList<String> user_pic2, ArrayList<String> updated2) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		TextView txtBlogTitle = (TextView) rowView.findViewById(R.id.tvIdeaTitle);
		...
		txtBlogTitle.setText("" + title.get(position));
		txtPhotoDescription.setText("" + description.get(position));
		
		String imageURL = blog_pic.get(position);
