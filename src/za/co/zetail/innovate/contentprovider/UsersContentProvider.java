...
import za.co.zetail.innovate.database.UsersTable;
...
public class UsersContentProvider extends ContentProvider {
	...
	private void checkColumns(String[] projection) {
		String[] available = { UsersTable.COLUMN_ID, UsersTable.COLUMN_NAME, UsersTable.COLUMN_EMAIL, 
				UsersTable.COLUMN_PICTURE, UsersTable.COLUMN_FOLLOWING, UsersTable.COLUMN_FOLLOWER};
		if (projection != null) {
